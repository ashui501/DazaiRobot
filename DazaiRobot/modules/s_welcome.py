...
def welcomepic(pic, user, chat, id, uname):
    background = Image.open("MukeshRobot/resources/nk.jpg")
    ...
    font = ImageFont.truetype('MukeshRobot/resources/SwanseaBold-D0ox.ttf', size=45)
    welcome_font = ImageFont.truetype('MukeshRobot/resources/SwanseaBold-D0ox.ttf', size=85)
    draw.text((30, 300), f'NAME: {unidecode(user)}', fill=(0, 250, 250), font=font)
    draw.text((30, 370), f'ID: {id}', fill=(0, 250, 250), font=font)
    draw.text((30, 40), f"Welcome to {unidecode(chat)}", fill=(140, 128, 128), font=welcome_font)
    draw.text((30,430), f"USERNAME : {uname}", fill=(0,250,250),font=font)
